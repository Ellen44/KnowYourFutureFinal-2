function getSOCsForJobTitle() {
	...
	$("#message").html("<h5>Click description for more information</h5>");
		$("#socstable tbody").html("<td align='center' style='background-color:darkblue'><font color='white'>Title</font></td><td align='center' style='background-color:darkblue'><font color='white'>Description</font></td>");
